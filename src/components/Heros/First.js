...
const First = () => {
  return (
      <>
        <div class="md:flex my-10 bg-white mx-6 dark:bg-gray-500 rounded-l-3xl">
            <div class="flex items-center justify-center w-full px-6 py-8 md:h-128 md:w-1/2">
                <div class="max-w-xl">
                    ...
                    <p class="mt-2 text-sm text-gray-500 dark:text-white md:text-base">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis commodi cum cupiditate ducimus, fugit harum id necessitatibus odio quam quasi, quibusdam rem tempora voluptates.</p>
