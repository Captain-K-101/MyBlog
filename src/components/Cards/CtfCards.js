        ...
        {repos.map((x, i) => (
          <div class="py-4 w-full h-full">
            <div class="shadow-lg group container  rounded-md bg-gray-200 dark:bg-gray-500 max-w-sm flex justify-center items-center  mx-auto ">
              <div>
                <div class="group-hover:opacity-50 w-full image-cover rounded-t-md">
                  <img
                    class="lg:h-auto md:h-auto w-auto object-cover object-center"
                    src={
                      "https://github.com/Captain-K-101/testrepo/blob/main/" +
                      x.path +
                      "/" +
                      x.path +
                      ".png?raw=true"
              ...
              <div class="absolute opacity-0 hover:opacity-100 hover:bg-transparent dark:bg-gray-500">
                <span class="text-3xl font-bold text-black tracking-wider dark:text-white leading-relaxed font-sans">
                  {x.path}
                </span>
